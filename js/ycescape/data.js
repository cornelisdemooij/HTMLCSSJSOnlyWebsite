...
let locations = {
  ...
  "h" : new Location("the hallway", true, [ "le", "re", "mr", "lr", "s", "w" ], [ "iron key 🗝", "note 🗒" ], []),
  "mr" : new Location("the men's room", false, [ "h" ], [ "Deodorant 🌺" ], [], "Mens Room.png"),
  "lr" : new Location("the ladies' room", true, [ "h" ], [], [], "Ladies Room.png"),
  ...
  "l" : new Location("the living room", true, [ "w", "k" ], [], [], "Living Room.jpg"),
  "t" : new Location("Thuis", true, [ "p", "oh" ], [], [], "Thuis.jpg"),
  "k" : new Location("the kitchen", true, [ "l", "o", "oh", "c" ], [], [], "Kitchen.jpg"),
